...
(function() {
    ...
    $(function() {
        ...
        var url = 'http://localhost:8003/jquery-file-upload/server.html/index.html';

        //uploaded files can be found in the file-uploads/jquery-file-upload/server.html/files/ folder
