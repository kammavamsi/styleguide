...
(function() {
    ...
    $(function() {
        ...
        new Chartist.Line('#chart1', data1, options1, responsiveOptions1);
        ...
        new Chartist.Line('#chart70', asyncData);
        ...
        new Chartist.Line('#chart80', data80);
        ...
        new Chartist.Pie('#chart30', data30);
        ...
        new Chartist.Pie('#chart31', data31, options31);
        ...
        new Chartist.Line('#chart3', data3, options3, responsiveOptions3);
        ...
        new Chartist.Line('#chart5', data5, options5);
        ...
        var chart6 = new Chartist.Line('#chart6', data6, options6);
        ...
        new Chartist.Bar('#chart7', data7, options7);
        ...
        new Chartist.Bar('#chart8', data8, options8, responsiveOptions8);
        ...
        new Chartist.Bar('#chart9', data9, options9);
        ...
        var chart10 = Chartist.Bar('#chart10', data10, options10);
        ...
        new Chartist.Bar('#chart11', data11, options11);
        ...
        new Chartist.Bar('#chart12', data12, options12, responsiveOptions12);
        ...
        new Chartist.Bar('#chart13', data13, options13);
        ...
        new Chartist.Pie('#chart14', data14, options14);
        ...
        new Chartist.Pie('#chart15', data15, options15, responsiveOptions15);
        ...
        new Chartist.Pie('#chart16', data16, options16);
